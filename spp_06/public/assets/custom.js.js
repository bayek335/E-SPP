...
tbl_cari.addEventListener('change', function(){
    ...
    console.log(level)
    if (level == 'admin') {
        var url_cetak_siswa = 'http://localhost/native/spp_06/public/'+'siswa/cetaksiswa.php?idk='+this.value
    ...
    var url = 'http://localhost/native/spp_06/public/'+'siswa/ajax-cari.php?idk='+keyword;
